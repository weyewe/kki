...
cilincing_office.geo_scopes << cilincing_subdistrict
...
loan_officer.assign_product( first_membership,  loan_product_a )
...
field_worker.add_initial_saving( first_membership,  20000)
field_worker.add_initial_saving( second_membership,  20000)
field_worker.add_initial_saving( third_membership,  20000)

field_worker.add_admin_fee( first_membership,  25000)
field_worker.add_admin_fee( second_membership,  25000)
field_worker.add_admin_fee( third_membership,  25000)
